  ...
  _createClass(MyApp, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
        var Component, ctx, pageProps, items, data;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                items = [];
                data = fetch('https://spreadsheets.google.com/feeds/list/1USp6UQtQqJYWlwPj0tZaIDnbsL51NSHCes09cFDDum0/od6/public/values?alt=json').then(function (response) {
                  return response.json();
                }).then(function (res) {
                  ...
                  var tags = _toConsumableArray(new Set(allTags)); // this.setState({
                  //   itemTypes,
                  //   titles,
                  //   loading: 'false',
                  //   tags
...
//# sourceMappingURL=_app.js.97b9e6afd9e178f802b3.hot-update.js.map